...
SplitWindow.prototype.getAutoAdjustScrollViewInsets = function (property) {
...
SplitWindow.prototype.setDetailView = function (property) {
	this.detailView = property;
};
...
SplitWindow.prototype.setLandscapeSplit = function (property) {
	this.landscapeSplit = property;
};
...
SplitWindow.prototype.setMasterIsOverlayed = function (property) {
	this.masterIsOverlayed = property;
};
SplitWindow.prototype.setMasterView = function (property) {
	this.masterView = property;
};
...
SplitWindow.prototype.setPortraitSplit = function (property) {
	this.portraitSplit = property;
};
