function DocumentViewer(properties) {
	...
	this.apiName = 'Titanium.UI.iOS.DocumentViewer';
...
DocumentViewer.prototype.getName = function(){ return this.name; };
...
DocumentViewer.prototype.getUrl = function(){ return this.url; };
...
DocumentViewer.prototype.setUrl = function(property){ this.url = property; };
