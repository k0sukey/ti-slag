...
AlertDialogStyle.prototype.applyProperties = function(params){ for (var key in params) { this[key] = params[key]; } };

AlertDialogStyle.prototype.fireEvent = function(){};

AlertDialogStyle.prototype.getApiName = function(){ return this.apiName; };

AlertDialogStyle.prototype.getBubbleParent = function(){ return this.bubbleParent; };

AlertDialogStyle.prototype.removeEventListener = function(){};

AlertDialogStyle.prototype.setBubbleParent = function(property){ this.bubbleParent = property; };

module.exports = function(properties){ return new AlertDialogStyle(properties); };