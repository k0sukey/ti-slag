...
Contacts.prototype.applyProperties = function(params){ for (var key in params) { this[key] = params[key]; } };

Contacts.prototype.createGroup = function(params){ var Group = require('./Contacts/Group'); return Group(params); };

Contacts.prototype.createPerson = function(params){ var Person = require('./Contacts/Person'); return Person(params); };

Contacts.prototype.fireEvent = function(){};

Contacts.prototype.getAllGroups = function(){ return []; };

Contacts.prototype.getAllPeople = function(){ return []; };

Contacts.prototype.getApiName = function(){ return this.apiName; };

Contacts.prototype.getBubbleParent = function(){ return this.bubbleParent; };

Contacts.prototype.getContactsAuthorization = function(){ return this.contactsAuthorization; };

Contacts.prototype.getGroupByID = function(){ return {}; };

Contacts.prototype.getLifecycleContainer = function(){ return this.lifecycleContainer; };

Contacts.prototype.getPeopleWithName = function(){ return []; };

Contacts.prototype.getPersonByID = function(){ return {}; };
...
Contacts.prototype.setBubbleParent = function(property){ this.bubbleParent = property; };

Contacts.prototype.setLifecycleContainer = function(property){ this.lifecycleContainer = property; };

Contacts.prototype.showContacts = function(){};

module.exports = function(properties){ return new Contacts(properties); };