...
PushNotifications.prototype.applyProperties = function(params){ for (var key in params) { this[key] = params[key]; } };

PushNotifications.prototype.getApiName = function(){ return this.apiName; };

PushNotifications.prototype.getBubbleParent = function(){ return this.bubbleParent; };

PushNotifications.prototype.getLifecycleContainer = function(){ return this.lifecycleContainer; };
...
PushNotifications.prototype.setBubbleParent = function(property){ this.bubbleParent = property; };

PushNotifications.prototype.setLifecycleContainer = function(property){ this.lifecycleContainer = property; };
...
module.exports = function(properties){ return new PushNotifications(properties); };