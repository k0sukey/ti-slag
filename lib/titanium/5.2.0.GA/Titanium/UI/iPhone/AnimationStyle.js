...
function AnimationStyle(__SLAG_PROPERTIES) {
	...
	if (__SLAG_PROPERTIES.CURL_DOWN) {
		throw new Error('Ti.UI.iPhone.AnimationStyle.CURL_DOWN was deprecated, since 6.0.0');
	}
	if (__SLAG_PROPERTIES.CURL_UP) {
		throw new Error('Ti.UI.iPhone.AnimationStyle.CURL_UP was deprecated, since 6.0.0');
	}
	if (__SLAG_PROPERTIES.FLIP_FROM_LEFT) {
		throw new Error('Ti.UI.iPhone.AnimationStyle.FLIP_FROM_LEFT was deprecated, since 6.0.0');
	}
	if (__SLAG_PROPERTIES.FLIP_FROM_RIGHT) {
		throw new Error('Ti.UI.iPhone.AnimationStyle.FLIP_FROM_RIGHT was deprecated, since 6.0.0');
	}
	if (__SLAG_PROPERTIES.NONE) {
		throw new Error('Ti.UI.iPhone.AnimationStyle.NONE was deprecated, since 6.0.0');
	}
