...
function TableView(__SLAG_PROPERTIES) {
	...
	if (__SLAG_PROPERTIES.separatorInsets) {
		throw new Error('Ti.UI.TableView.separatorInsets was deprecated, since 6.0.0');
	}
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
...
TableView.prototype.getSeparatorInsets = function () {
	throw new Error('Ti.UI.TableView.getSeparatorInsets was deprecated, since 6.0.0');
};
TableView.prototype.setSeparatorInsets = function () {
	throw new Error('Ti.UI.TableView.setSeparatorInsets was deprecated, since 6.0.0');
};
