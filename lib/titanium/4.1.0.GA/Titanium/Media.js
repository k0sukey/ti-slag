...
function Media(__SLAG__properties) {
	...
	if (__SLAG__properties.cameraAuthorizationStatus) {
		throw new Error('Ti.Media.cameraAuthorizationStatus is read only property');
	}
	this.cameraAuthorizationStatus = 0;
