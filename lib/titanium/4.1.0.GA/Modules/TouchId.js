...
function TouchId(__SLAG_PROPERTIES) {
	...
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ERROR_AUTHENTICATION_FAILED = undefined;
	} else {
	...
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ERROR_PASSCODE_NOT_SET = undefined;
	} else {
	...
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ERROR_TOUCH_ID_NOT_AVAILABLE = undefined;
	} else {
	...
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ERROR_TOUCH_ID_NOT_ENROLLED = undefined;
	} else {
	...
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ERROR_SYSTEM_CANCEL = undefined;
	} else {
	...
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ERROR_USER_CANCEL = undefined;
	} else {
	...
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ERROR_USER_FALLBACK = undefined;
	} else {
