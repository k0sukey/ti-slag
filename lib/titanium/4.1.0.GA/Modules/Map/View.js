function View(properties) {
	...
	this.zOrderOnTop = properties.zOrderOnTop || true;
	this.region = properties.region || {};
	this.userLocation = properties.userLocation || true;
	this.userLocationButton = properties.userLocationButton || true;
	this.compassEnabled = properties.compassEnabled || true;
	this.enableZoomControls = properties.enableZoomControls || true;
	this.maxZoomLevel = properties.maxZoomLevel || 0;
	this.minZoomLevel = properties.minZoomLevel || 0;
	this.traffic = properties.traffic || true;
	this.camera = properties.camera || {};
	this.pitchEnabled = properties.pitchEnabled || true;
	this.rotateEnabled = properties.rotateEnabled || true;
	this.showsBuildings = properties.showsBuildings || true;
	this.showsPointsOfInterest = properties.showsPointsOfInterest || true;
	return this;
}
...
View.prototype.setZOrderOnTop = function () {
};
...
View.prototype.setUserLocationButton = function () {
};
View.prototype.getCompassEnabled = function () {
	return true;
};
View.prototype.setCompassEnabled = function () {
};
View.prototype.getEnableZoomControls = function () {
	return true;
};
View.prototype.setEnableZoomControls = function () {
};
...
View.prototype.setTraffic = function () {
};
...
View.prototype.setPitchEnabled = function () {
};
View.prototype.getRotateEnabled = function () {
	return true;
};
View.prototype.setRotateEnabled = function () {
};
View.prototype.getShowsBuildings = function () {
	return true;
};
View.prototype.setShowsBuildings = function () {
};
View.prototype.getShowsPointsOfInterest = function () {
	return true;
};
View.prototype.setShowsPointsOfInterest = function () {
};
