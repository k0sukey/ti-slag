...
function View(__SLAG_PROPERTIES) {
	...
	if ([
		...
		this.zOrderOnTop = undefined;
	} else {
		this.zOrderOnTop = __SLAG_PROPERTIES.zOrderOnTop || true;
	}
	if ([
			'android',
			'ios'
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.userLocationButton = undefined;
	} else {
		this.userLocationButton = __SLAG_PROPERTIES.userLocationButton || true;
	}
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.compassEnabled = undefined;
	} else {
		this.compassEnabled = __SLAG_PROPERTIES.compassEnabled || true;
	}
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		...
		this.traffic = __SLAG_PROPERTIES.traffic || true;
	}
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
	...
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.pitchEnabled = undefined;
	} else {
		this.pitchEnabled = __SLAG_PROPERTIES.pitchEnabled || true;
	}
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.rotateEnabled = undefined;
	} else {
		this.rotateEnabled = __SLAG_PROPERTIES.rotateEnabled || true;
	}
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.showsBuildings = undefined;
	} else {
		this.showsBuildings = __SLAG_PROPERTIES.showsBuildings || true;
	}
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.showsPointsOfInterest = undefined;
	} else {
		this.showsPointsOfInterest = __SLAG_PROPERTIES.showsPointsOfInterest || true;
	}
...
View.prototype.setZOrderOnTop = function (__SLAG__PROPERTY) {
	if ([
			'android',
			'ios'
		].indexOf(process.env.SLAG_PLATFORM) === -1) {
	...
	this.zOrderOnTop = __SLAG__PROPERTY;
};
...
View.prototype.setUserLocationButton = function (__SLAG__PROPERTY) {
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.userLocationButton = __SLAG__PROPERTY;
};
...
View.prototype.setCompassEnabled = function (__SLAG__PROPERTY) {
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.compassEnabled = __SLAG__PROPERTY;
};
...
View.prototype.setEnableZoomControls = function (__SLAG__PROPERTY) {
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
...
View.prototype.setTraffic = function (__SLAG__PROPERTY) {
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.traffic = __SLAG__PROPERTY;
};
...
View.prototype.setCamera = function (__SLAG__PROPERTY) {
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.camera = __SLAG__PROPERTY;
};
...
View.prototype.setPitchEnabled = function (__SLAG__PROPERTY) {
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.pitchEnabled = __SLAG__PROPERTY;
};
...
View.prototype.setRotateEnabled = function (__SLAG__PROPERTY) {
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.rotateEnabled = __SLAG__PROPERTY;
};
...
View.prototype.setShowsBuildings = function (__SLAG__PROPERTY) {
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.showsBuildings = __SLAG__PROPERTY;
};
...
View.prototype.setShowsPointsOfInterest = function (__SLAG__PROPERTY) {
	if (['ios'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.showsPointsOfInterest = __SLAG__PROPERTY;
};
