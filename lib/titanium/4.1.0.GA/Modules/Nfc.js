...
function Nfc(__SLAG_PROPERTIES) {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ACTION_NDEF_DISCOVERED = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ACTION_TAG_DISCOVERED = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.ACTION_TECH_DISCOVERED = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TNF_ABSOLUTE_URI = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TNF_EXTERNAL_TYPE = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RTD_ALTERNATIVE_CARRIER = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RTD_HANDOVER_CARRIER = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RTD_HANDOVER_REQUEST = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RTD_HANDOVER_SELECT = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RTD_SMART_POSTER = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TECH_MIFARE_CLASSIC = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TECH_MIFARE_ULTRALIGHT = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TECH_NDEFFORMATABLE = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RECOMMENDED_ACTION_UNKNOWN = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RECOMMENDED_ACTION_DO_ACTION = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RECOMMENDED_ACTION_SAVE_FOR_LATER = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.RECOMMENDED_ACTION_OPEN_FOR_EDITING = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TAG_TYPE_NFC_FORUM_TYPE_1 = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TAG_TYPE_NFC_FORUM_TYPE_2 = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TAG_TYPE_NFC_FORUM_TYPE_3 = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TAG_TYPE_NFC_FORUM_TYPE_4 = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.TAG_TYPE_MIFARE_CLASSIC = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_TAG_TYPE_CLASSIC = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_TAG_TYPE_PLUS = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_TAG_TYPE_PRO = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_TAG_TYPE_UNKNOWN = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_BLOCK_SIZE = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_SIZE_MINI = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_ULTRALIGHT_PAGE_SIZE = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_ULTRALIGHT_TYPE_ULTRALIGHT = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_ULTRALIGHT_TYPE_ULTRALIGHT_C = undefined;
	} else {
	...
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.MIFARE_ULTRALIGHT_TYPE_UNKNOWN = undefined;
	} else {
