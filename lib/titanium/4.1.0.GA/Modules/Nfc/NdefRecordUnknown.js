...
function NdefRecordUnknown(__SLAG__properties) {
...
NdefRecordUnknown.prototype.setLifecycleContainer = function (property) {
	this.lifecycleContainer = property;
};
NdefRecordUnknown.prototype.getPayload = function () {
	return this.payload;
};
NdefRecordUnknown.prototype.setPayload = function (property) {
