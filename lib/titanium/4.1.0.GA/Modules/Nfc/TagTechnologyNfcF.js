...
function TagTechnologyNfcF(__SLAG__properties) {
...
TagTechnologyNfcF.prototype.setLifecycleContainer = function (property) {
	this.lifecycleContainer = property;
};
TagTechnologyNfcF.prototype.getTag = function () {
	return this.tag;
};
TagTechnologyNfcF.prototype.setTag = function (property) {
	this.tag = property;
};
