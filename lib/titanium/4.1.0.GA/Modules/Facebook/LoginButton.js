...
function LoginButton(__SLAG_PROPERTIES) {
	...
	if ([
		...
		this.audience = __SLAG_PROPERTIES.audience || 0;
	}
	if ([
			'android',
			'ios'
		].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.readPermissions = undefined;
	} else {
		this.readPermissions = __SLAG_PROPERTIES.readPermissions || '';
	}
	if ([
			'android',
			'ios'
		].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.publishPermissions = undefined;
	} else {
		this.publishPermissions = __SLAG_PROPERTIES.publishPermissions || '';
	}
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		this.sessionLoginBehavior = undefined;
	} else {
		this.sessionLoginBehavior = __SLAG_PROPERTIES.sessionLoginBehavior || 0;
	}
...
LoginButton.prototype.setAudience = function (__SLAG__PROPERTY) {
	if ([
			'android',
			'ios'
		].indexOf(process.env.SLAG_PLATFORM) === -1) {
	...
	this.audience = __SLAG__PROPERTY;
};
...
LoginButton.prototype.setReadPermissions = function (__SLAG__PROPERTY) {
	if ([
			'android',
			'ios'
		].indexOf(process.env.SLAG_PLATFORM) === -1) {
	...
	this.readPermissions = __SLAG__PROPERTY;
};
...
LoginButton.prototype.setPublishPermissions = function (__SLAG__PROPERTY) {
	if ([
			'android',
			'ios'
		].indexOf(process.env.SLAG_PLATFORM) === -1) {
	...
	this.publishPermissions = __SLAG__PROPERTY;
};
...
LoginButton.prototype.setSessionLoginBehavior = function (__SLAG__PROPERTY) {
	if (['android'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	this.sessionLoginBehavior = __SLAG__PROPERTY;
};
