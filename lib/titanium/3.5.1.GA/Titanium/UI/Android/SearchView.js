function SearchView(properties) {
	...
	if (properties.enabled) {
		throw new Error('Ti.UI.Android.SearchView.enabled was deprecated, since 3.3.0');
	}
...
SearchView.prototype.getEnabled = function () {
	throw new Error('Ti.UI.Android.SearchView.getEnabled was deprecated, since 3.3.0');
};
...
SearchView.prototype.setEnabled = function () {
	throw new Error('Ti.UI.Android.SearchView.setEnabled was deprecated, since 3.3.0');
};
