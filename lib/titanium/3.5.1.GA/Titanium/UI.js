...
function UI(__SLAG_PROPERTIES) {
	...
	if ([
		...
		this.KEYBOARD_DECIMAL_PAD = undefined;
	} else {
	...
	if ([
		...
		this.KEYBOARD_DEFAULT = undefined;
	} else {
	...
	if ([
		...
		this.KEYBOARD_NAMEPHONE_PAD = undefined;
	} else {
	...
	if ([
		...
		this.KEYBOARD_NUMBERS_PUNCTUATION = undefined;
	} else {
	...
	if ([
		...
		this.KEYBOARD_NUMBER_PAD = undefined;
	} else {
	...
	if ([
		...
		this.KEYBOARD_PHONE_PAD = undefined;
	} else {
...
UI.prototype.createSMSDialog = function (__SLAG_PROPERTY) {
	if (['tizen'].indexOf(process.env.SLAG_PLATFORM) === -1) {
		throw new Error('This method is not support specified platform');
	}
	var SMSDialog = require('./UI/SMSDialog');
	return SMSDialog(__SLAG_PROPERTY);
};
