...
function Android(__SLAG__properties) {
	...
	if (__SLAG__properties.CATEGORY_ALARM) {
	...
	if (__SLAG__properties.CATEGORY_CALL) {
	...
	if (__SLAG__properties.CATEGORY_EMAIL) {
	...
	this.CATEGORY_EMBED = '';
	if (__SLAG__properties.CATEGORY_ERROR) {
		throw new Error('Ti.Android.CATEGORY_ERROR is read only property');
	}
	this.CATEGORY_ERROR = '';
	if (__SLAG__properties.CATEGORY_EVENT) {
	...
	if (__SLAG__properties.CATEGORY_MESSAGE) {
	...
	this.CATEGORY_TEST = '';
	if (__SLAG__properties.CATEGORY_TRANSPORT) {
	...
	if (__SLAG__properties.VISIBILITY_SECRET) {
